...
describe('Object utils', () => {
  ...
  describe('detectRemovals', () => {
    beforeEach(() => {
      ...
      delete after['level1']['level2']['level3']['level4']['level5'][
        'level5Str'
      ];
  ...
  describe('detectLiteralChanges', () => {
    ...
    it(
      'should detect all literal changes, and no other changes (to objects ' +
        'or arrays)',
      () => {
  ...
  describe('updateLiteralsByDotPath', () => {
    ...
    it('should update number nested 3 levels into object', () => {
      ...
      assert.isTrue(after['level1']['level2']['level3']['level3Num'] === 999);
    });
  });
  ...
  describe('removePropsByDotPath', () => {
    ...
    it('should remove property nested 3 levels in', () => {
      assert.isTrue(
        before['level1']['level2']['level3'].hasOwnProperty('level3Num')
      );
      assert.isFalse(
        after['level1']['level2']['level3'].hasOwnProperty('level3Num')
      );
    });
    ...
    it('should remove element from array nested 3 levels in', () => {
      assert.isTrue(
        after['level1']['level2']['level3']['level3Arr'].includes(
  ...
  describe('syncObjectsWithPreference', () => {
    ...
    it('should create an object which is the union of both inputs', () => {
      function hasAllPropsFrom(
        checkObj: ConfigObj,
        againstObj: ConfigObj
      ): boolean {
        let result = true;
        for (let prop in againstObj) {
          if (!checkObj.hasOwnProperty(prop)) {
            ...
            typeof againstObj[prop] === 'object' &&
            !Array.isArray(againstObj[prop])
          ) {
            if (
              !hasAllPropsFrom(
                checkObj[prop] as ConfigObj,
    ...
    it('should merge arrays', () => {
      function allArraysInObjReflectSource(
        checkObj: ConfigObj,
        againstObj: ConfigObj
      ): boolean {
        let result = true;
    ...
    it("should use primary object's properties when a property is defined on both inputs", () => {
      function reflectsAllLiteralsFromSource(
        checkObj: ConfigObj,
        againstObj: ConfigObj
      ): boolean {
        let result = true;
